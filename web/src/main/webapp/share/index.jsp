...
<head>
  ...
  <meta property="og:url" content="http://daveclay.com?gid=<%= request.getParameter("gid") %>&pid=<%= request.getParameter("pid") %>" />
  <meta property="og:image" content="http://daveclay.com/services/images/image/original/<%= request.getParameter("pid") %>" />
  <meta name="viewport"
